...
<head>
    ...
    <title>Ответы на вопросы | JaGGeRShop</title>
...
<body class="min-h-screen flex flex-col bg-background text-foreground">
    ...
    <main class="flex-grow container py-12" style="max-width: 900px;">
        <h1 class="title-accent" style="text-align: left; margin-bottom: 40px;">Ответы на вопросы</h1>
        
        <div class="faq-accordion">
            <!-- Вопрос 1 -->
            <div class="faq-item">
                <div class="faq-trigger" onclick="toggleFaq(this)">
                    <span>Пишет, что у меня есть один неоплаченный заказ</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-arrow-svg">
                        <polyline points="6 9 12 15 18 9"></polyline>
                    </svg>
                </div>
                <div class="faq-content">
                    <p>Скорей всего вы перешли на страницу оплаты, но не оплатили заказ. Повторное создание заказа на этот же номер телефона будет доступно через 15 минут. Дождитесь этого времени или откройте, закрытую вами вкладку со страницей оплаты.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                <div class="faq-trigger" onclick="toggleFaq(this)">
                    <span>Когда будет новая поставка мерча?</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-arrow-svg">
                        <polyline points="6 9 12 15 18 9"></polyline>
                    </svg>
                </div>
                <div class="faq-content">
                    <p>Точной даты новой поставки мерча нет. Следите за пополнением товара на сайте.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                <div class="faq-trigger" onclick="toggleFaq(this)">
                    <span>Когда дадут трек-номер заказа?</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-arrow-svg">
                        <polyline points="6 9 12 15 18 9"></polyline>
                    </svg>
                </div>
                <div class="faq-content">
                    <p>Трек-номер отправляется сразу после обработки вашего заказа и добавления его в лист отправлений. На это может уйти какое-то время.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                <div class="faq-trigger" onclick="toggleFaq(this)">
                    <span>В какие страны может быть организована доставка?</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-arrow-svg">
                        <polyline points="6 9 12 15 18 9"></polyline>
                    </svg>
                </div>
                <div class="faq-content">
                    <p>Доставка товара осуществляется по странам ЕАЭС посредством использования ТК СДЭК.</p>
                </div>
            </div>
        </div>
    </main>
